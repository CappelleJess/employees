 ...
 */
class getEmpProjectRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmpProjectRepository' shared autowired service.
     *
     * @return \App\Repository\EmpProjectRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmpProjectRepository.php';

        return $container->privates['App\\Repository\\EmpProjectRepository'] = new \App\Repository\EmpProjectRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
